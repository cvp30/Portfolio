export const Github = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="hover:drop-shadow-icon dark:hover:drop-shadow-iconDark" width="28" height="28" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
...
export const Linkedin = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="hover:drop-shadow-icon dark:hover:drop-shadow-iconDark" width="32" height="32" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
...
export const Mail = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="hover:drop-shadow-icon dark:hover:drop-shadow-iconDark" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
