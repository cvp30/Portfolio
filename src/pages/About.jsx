...
const About = () => {
  return (
    <div id="about" className="w-full h-screen flex flex-col items-center font-bold pt-24 border">
      <h2 className="underline underline-offset-[1rem]">About Me</h2>
    </div>
    // <div id="about" className="w-full h-full flex p-4">
