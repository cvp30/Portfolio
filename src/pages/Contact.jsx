    ...
    <div id="contact" className="w-full max-w-screen-2xl mx-auto h-screen flex flex-col gap-8 items-center pt-10 font-bold">
      ...
      <div className='relative shadow-lg shadow-dark dark:shadow-white box-border bg-no-repeat h-5/6 max-w-screen-2xl aspect-video flex'>
        <div className='z-10 w-1/3 h-full flex flex-col items-start justify-around p-14 dark:text-white font-bold pl-8'>
          ...
          <Link className='flex gap-3' to="https://github.com/cvp30" target="_blank">
            <Github />
            /cvp30
          </Link>
          <Link className='flex gap-3' to="https://www.linkedin.com/in/carlosvaler/" target="_blank">
            <Linkedin />
            /carlosvaler
          </Link>
          <Link className='flex gap-3' to="https://twitter.com/carlosvaler17" target="_blank">
            <Twitter />
            /carlosvaler17
          </Link>
        </div>

        <form ref={formRef} className='z-10 w-2/3 h-full px-20 py-10  flex flex-col items-center justify-between gap-3 dark:text-white text-sm'>
