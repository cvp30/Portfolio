...
const Home = () => {
  ...
  return (
    <div id="home" className="truncate relative w-full h-screen ">
      ...
      <div className="w-full h-full flex z-20 mt-24 font-extrabold">
        ...
        <div className=" w-1/2 h-full flex flex-col items-center pt-12 gap-12 ">
          <img className="w-96 " src="http://marveltheme.com/tf/html/johny/johny-legend/img/dark/profile.jpg" alt="" />
