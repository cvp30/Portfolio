...
const Skills = () => {
  ...
  return (
    <div id="skills" className="w-full h-200 pt-16 px-24 text-center bg-[#202831]">
      ...
      <div className={!active?"border h-3/5 mt-12 w-5/6 m-auto flex justify-center items-center":"hidden"}>
        <div className="h-96 w-96 rounded-full border relative">
          <div className="flex gap-2 items-center absolute -left-16 -top-4">
            <p>Time Management</p>
            <div className="w-16 h-16 rounded-full p-1 border-8 border-[#dccb47] bg-white">
          ...
          {/* <div className="flex gap-2 items-center absolute  -left-48">
            <p>Emotional Intelligence</p>
            <div className="w-16 h-16 rounded-full p-1 border-8 border-[#dccb47] bg-white">
              <img src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/64/null/external-emotional-human-resources-flaticons-lineal-color-flat-icons.png" alt="" />
            </div>
